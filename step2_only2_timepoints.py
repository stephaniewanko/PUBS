...
#Author: Christina Stephens and Laura Gunsalus
...
if __name__ == "__main__":
    ...
    required.add_argument('-c', '--barcode_csv',  nargs='*',required=True,
                          help='preprocessed csv file containing sequenced barcodes and wt-normalized frequencies from three time points. when calculating fitness values '
    ...
    print("raw count for timepoint (2): " + str(raw_counts[0]) + "  timepoint (1): " + str(raw_counts[1]))
    print("")
